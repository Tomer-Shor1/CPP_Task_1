...
namespace ariel
{
    ...
    // check whether the graph is valid - meaning if the ajf matrix is cubical
    ...
    // prints the adjacent matrix representing the graph
    ...
    Graph Graph::operator-(const Graph &other) const
    {
        ...
        return newGraph; // Return by value, not by reference
    }
